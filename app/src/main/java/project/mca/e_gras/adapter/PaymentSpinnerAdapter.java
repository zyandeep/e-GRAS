...
public class PaymentSpinnerAdapter extends ArrayAdapter<PaymentModel> {

    public PaymentSpinnerAdapter(@NonNull Context context, @NonNull List<PaymentModel> modelList) {
